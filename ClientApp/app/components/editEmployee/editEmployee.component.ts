...
export class editEmployeeComponent {
    ...
    public constructor(private empService: EmployeeServices, private activatedRoute: ActivatedRoute, private router: Router) {
        ...
        if (this.formData.valid) {
            ...
            this.empService.editEmployeeData(Obj)
                .subscribe((data: Response) => {
                    ...
                    this.router.navigate(['/details/', this.EmpId ]);
              }
            );
